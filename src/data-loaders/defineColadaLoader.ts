...
import type { _DefineLoaderEntryMap, _PromiseMerged, DataLoaderContextBase, DataLoaderEntryBase, DefineDataLoaderOptionsBase_LaxData, DefineLoaderFn, ErrorDefault, UseDataLoader, UseDataLoaderResult } from 'vite-plugin-routes/data-loaders'
...
function toValueWithParameters<T, Arg>(optionValue: T | ((arg: Arg) => T), arg: Arg): T {
